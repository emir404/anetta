...
export function Termin({
  ...
  headingLines = ["Termin", "vereinbaren"],
  intro = "Termine vergeben wir persönlich am Telefon — so finden wir gemeinsam den Zeitpunkt, der Ihnen passt, und nehmen uns die Zeit, die Ihr Haar braucht. Rufen Sie uns gerne zu den Öffnungszeiten an. Wir freuen uns auf Sie!",
  ...
  const openState = useOpenState(hours);
