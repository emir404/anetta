...
type HeroProps = {
  ...
  serviceCards?: { label: string; image: string; alt: string }[];
  hoursLine?: string;
  groupsLine?: string;
  logo?: { src: string; alt: string };
};

const DEFAULT_HOURS_LINE = "Di–Fr 09:00–18:00 · Sa 08:00–13:00";

export function Hero({
  salon = SALON,
  serviceCards = SERVICE_CARDS,
  hoursLine = DEFAULT_HOURS_LINE,
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-blue">
        ...
        >
          <p className="tabular-nums">{hoursLine}</p>
          <a
            href={MAPS_URL}
            target="_blank"
